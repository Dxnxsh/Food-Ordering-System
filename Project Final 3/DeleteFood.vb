...
Public Class DeleteFood
    ...
    Private Sub DeleteFood_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        For Each row As DataRow In data.Rows
            ...
            checkBox.Text = row("FoodName").ToString
    ...
    Private Function RetrieveDataFromDatabase() As DataTable
        ...
        Dim query As String = "SELECT FoodName FROM FoodList" ' Replace "YourTableName" with the appropriate table name in your database
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles btnDel.Click
        ...
        For Each control As Control In FlowLayoutPanel1.Controls
            If TypeOf control Is CheckBox AndAlso DirectCast(control, CheckBox).Checked Then
                Dim FoodName As String = DirectCast(control, CheckBox).Text
        ...
        DeleteFood_Load(Nothing, Nothing)
    End Sub

    Private Sub DeleteEntry(foodname As String)
        ' Perform the deletion in the database
        Dim connectionString As String = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=C:\Users\danis\Documents\FoodDatabase.mdb"
        Dim query As String = "DELETE FROM FoodList WHERE FoodName = @foodname"
