...
Public Class AdminHistory
    Private Sub AdminHistory_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        For Each row As DataRow In data.Rows
            ...
            priceLabel.Location = New Point(panel.Width - 100, 10)
            priceLabel.Width = CInt(panel.Width * 0.8)
    ...
    Private Function RetrieveDataFromDatabase() As DataTable
        ...
        Dim query As String = "SELECT * FROM OrderHistory" ' Replace "YourTableName" with the appropriate table name in your database
